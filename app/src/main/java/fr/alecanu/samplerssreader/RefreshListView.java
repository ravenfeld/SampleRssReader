...
public class RefreshListView extends ListView {
    ...
    public boolean dispatchTouchEvent(final MotionEvent ev) {
        if (enabledPull && ev.getAction() == MotionEvent.ACTION_MOVE && getFirstVisiblePosition() == 0) {
     ...
     *
     * @param enabled True if this pull is enabled, false otherwise.
     */
    public void setEnabledPull(boolean enabled) {
        enabledPull = enabled;
    }
}
